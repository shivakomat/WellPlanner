...
CREATE TABLE "timeline_items" ("id" SERIAL PRIMARY KEY, "business_id" SERIAL, "project_id" SERIAL, "duration" NUMERIC, "description" VARCHAR(200), "time" VARCHAR(10), "date" NUMERIC, "contact" VARCHAR(100), "notes" VARCHAR(1000),
