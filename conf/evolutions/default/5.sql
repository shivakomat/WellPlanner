...
insert into "projects" (name, event_type, brides_name, grooms_name, budget, event_date, client_id, business_id, modified_date, created_date) values ('Radhika & Shiva', 'WEDDING', 'Radhika', 'Shiv', 4000, 20102020, 1, 1, 10102020, 10102020, false);
